...
public static partial class Localization
{
    internal static readonly Dictionary<string, string> _fr = new()
    {
        ...
        ["settings.hotkey.desc"]   = "Appelez la fenêtre depuis n'importe quelle app avec Win+Alt+S ; appuyez à nouveau pour la masquer.",
        ...
        ["sc.clearSearch"]  = "Effacer la recherche",
        ...
        ["sc.upFirst"]      = "↑ (sur la première ligne)",
        ["sc.backToSearch"] = "Retour au champ de recherche",
        ["sc.dblClick"]     = "Double-clic",
        ["sc.globalSc"]     = "Raccourci global",
        ["sc.toggleApp"]    = "Afficher/masquer l'app depuis n'importe où",
        ["sc.globalHotkey"] = "Afficher / masquer la fenêtre (depuis n'importe quelle app)",
