...
public static partial class Localization
{
    internal static readonly Dictionary<string, string> _de = new()
    {
        ...
        ["settings.hotkey.desc"]   = "Fenster aus jeder App mit Win+Alt+S holen; erneut drücken blendet es in den Infobereich aus.",
        ...
        ["sc.upFirst"]      = "↑ (in der ersten Zeile)",
        ["sc.backToSearch"] = "Zurück zum Suchfeld",
        ["sc.dblClick"]     = "Doppelklick",
        ["sc.globalSc"]     = "Globales Kürzel",
        ["sc.toggleApp"]    = "App von überall ein-/ausblenden",
        ["sc.globalHotkey"] = "Fenster ein- / ausblenden (aus jeder App)",
