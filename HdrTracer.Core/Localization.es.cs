...
public static partial class Localization
{
    internal static readonly Dictionary<string, string> _es = new()
    {
        ...
        ["col.path"]   = "Ruta",
        ["col.size"]   = "Tamaño",
        ["col.date"]   = "Fecha de modificación",
        ...
        ["settings.hotkey.desc"]   = "Abre la ventana desde cualquier app con Win+Alt+S; púlsalo de nuevo para ocultarla en la bandeja.",
        ...
        ["sc.clearSearch"]  = "Borrar la búsqueda",
        ...
        ["sc.upFirst"]      = "↑ (en la primera fila)",
        ["sc.backToSearch"] = "Volver al cuadro de búsqueda",
        ["sc.dblClick"]     = "Doble clic",
        ["sc.globalSc"]     = "Atajo global",
        ["sc.toggleApp"]    = "Mostrar/ocultar la app desde cualquier sitio",
        ["sc.globalHotkey"] = "Mostrar / ocultar la ventana (desde cualquier app)",
